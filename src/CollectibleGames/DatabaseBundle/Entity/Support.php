...
class Support
{
     ...
     * @var string
     *
     * @ORM\Column(name="nom_support", type="string", length=255)
     */
    private $name;
	
	 /**
     * @ORM\Column(name="support_valide", type="boolean")
     */
	protected $valide;
	
	 /**
     * @ORM\Column(name="logo_support", type="string", length=255)
     */
	protected $imageUrl;
	protected $image;
