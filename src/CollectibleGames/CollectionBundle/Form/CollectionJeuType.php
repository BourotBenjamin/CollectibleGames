...
class CollectionJeuType extends AbstractType
{
  ...
  {
		$builder
			->add('version',        'entity', array('class' => 'CollectibleGamesDatabaseBundle:VersionJeu',
			...
			->add('cartouche',        'checkbox', array('required'  => false))
  ...
  public function setDefaultOptions(OptionsResolverInterface $resolver)
  {
    $resolver->setDefaults(array(
      'data_class' => 'CollectibleGames\CollectionBundle\Entity\CollectionJeu'
    ));
  }

  public function getName()
  {
    return 'collectiblegames_collectionbundle_collectionjeutype';
  }
